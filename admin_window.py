...
def add_mark():
    ...
    class_options = ["1", "2", "3", "4", "5"]  # Add more options if needed
    class_var = tk.StringVar(root)
    class_var.set(class_options[0])  # Set the default option
    class_entry = tk.OptionMenu(addmark, class_var, *class_options)
    class_entry.grid(row=0, column=1, padx=5, pady=5, sticky=tk.W)
    # class_entry.config(width=10)
    ...
    roll_label = tk.Label(addmark, text="Roll no")
    roll_label.grid(row=2, column=0, padx=5, pady=5, sticky=tk.W)
    roll_entry = tk.Entry(addmark)
    roll_entry.grid(row=2, column=1, padx=5, pady=5)

    subj1_label = tk.Label(addmark, text="Subject 1")
    subj1_label.grid(row=3, column=0, padx=5, pady=5, sticky=tk.W)
    sub1_entry = tk.Entry(addmark)
    sub1_entry.grid(row=3, column=1, padx=5, pady=5)

    sub2_label = tk.Label(addmark, text="subject 2")
    sub2_label.grid(row=4, column=0, padx=5, pady=5, sticky=tk.W)
    sub2_entry = tk.Entry(addmark)
    sub2_entry.grid(row=4, column=1, padx=5, pady=5)

    sub3_label = tk.Label(addmark, text="subject 3")
    sub3_label.grid(row=5, column=0, padx=5, pady=5, sticky=tk.W)
    sub3_entry = tk.Entry(addmark)
    sub3_entry.grid(row=5, column=1, padx=5, pady=5)

    sub4_label = tk.Label(addmark, text="Subject 4")
    sub4_label.grid(row=6, column=0, padx=5, pady=5, sticky=tk.W)
    sub4_entry = tk.Entry(addmark)
    sub4_entry.grid(row=6, column=1, padx=5, pady=5)

    submit = tk.Button(addmark, text="Submit")
    submit.grid(row=7, column=1, sticky=tk.E)
...
def mangae_marks():
    ...
    update.grid(row=0, column=1, padx=20, pady=20, sticky=tk.NSEW)

    class_label = tk.Label(update, text="Class :")
    class_label.grid(row=0, column=0, sticky=tk.W)
    class_options = ["1", "2", "3", "4", "5"]  # Add more options if needed
    class_var = tk.StringVar(root)
    class_var.set(class_options[0])  # Set the default option
    class_entry = tk.OptionMenu(update, class_var, *class_options)
    class_entry.grid(row=0, column=1, padx=5, pady=5, sticky=tk.W)
    # class_entry.config(width=10)

    name_label = tk.Label(update, text="Name:")
    name_label.grid(row=1, column=0, padx=5, pady=5, sticky=tk.W)
    name_entry = tk.Entry(update)
    name_entry.grid(row=1, column=1, padx=5, pady=5)

    roll_label = tk.Label(update, text="Roll no")
    roll_label.grid(row=2, column=0, padx=5, pady=5, sticky=tk.W)
    roll_entry = tk.Entry(update)
    roll_entry.grid(row=2, column=1, padx=5, pady=5)

    subj1_label = tk.Label(update, text="Subject 1")
    subj1_label.grid(row=3, column=0, padx=5, pady=5, sticky=tk.W)
    sub1_entry = tk.Entry(update)
    sub1_entry.grid(row=3, column=1, padx=5, pady=5)

    sub2_label = tk.Label(update, text="subject 2")
    sub2_label.grid(row=4, column=0, padx=5, pady=5, sticky=tk.W)
    sub2_entry = tk.Entry(update)
    sub2_entry.grid(row=4, column=1, padx=5, pady=5)

    sub3_label = tk.Label(update, text="subject 3")
    sub3_label.grid(row=5, column=0, padx=5, pady=5, sticky=tk.W)
    sub3_entry = tk.Entry(update)
    sub3_entry.grid(row=5, column=1, padx=5, pady=5)

    sub4_label = tk.Label(update, text="Subject 4")
    sub4_label.grid(row=6, column=0, padx=5, pady=5, sticky=tk.W)
    sub4_entry = tk.Entry(update)
    sub4_entry.grid(row=6, column=1, padx=5, pady=5)

    submit = tk.Button(update, text="Update")
    submit.grid(row=7, column=1, sticky=tk.E)
...
def absent_mail():
    ...
    def send_absent_email():
        ...
        message = "Test run".format(name_entry.get(), name_entry.get(), roll_entry.get(), class_entry.get(),
                                    section_entry.get())
...
edit_mark = tk.Button(sidebar, command=mangae_marks, text="Manage Mark", bd=0, bg="gray", foreground="white")
